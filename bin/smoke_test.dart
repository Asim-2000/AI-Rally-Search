...
import '../test/eval/eval_models.dart';
...
void main(List<String> args) async {
  ...
  for (int i = 0; i < smokeCases.length; i++) {
    ...
    if (result.requiresClarification) {
      print('ℹ️ Clarification Requested: "${result.clarificationPrompt}"');
      print('Expected Clarification: ${testCase.expectedClarification}');
      ...
      print('  • ActionType: ${sq.actionType?.name}');
